...
export default function CandidateFinalReport({ 
  ...
  const DocumentHeader = ({ title, subtitle }: { title: string, subtitle: string }) => (
    <div style={{ textAlign: 'center', borderBottom: '3px solid #1e3a8a', paddingBottom: '10px', marginBottom: '12px' }}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '20px', marginBottom: '8px' }}>
        <img src="/images/logos/MBMlogo.png" alt="Logo MBM" style={{ height: '40px', objectFit: 'contain' }} />
        <div style={{ height: '30px', width: '2px', backgroundColor: '#cbd5e1', borderRadius: '2px' }}></div>
        <img src="/images/logos/ptLogoText.png" alt="Logo Partner" style={{ height: '35px', objectFit: 'contain' }} />
      </div>
      <h1 style={{ fontSize: '16px', color: '#1e3a8a', margin: '0 0 2px 0', letterSpacing: '1px', fontWeight: '900', textTransform: 'uppercase' }}>{title}</h1>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px', backgroundColor: '#f8fafc', padding: '8px 12px', borderRadius: '4px', border: '1px solid #e2e8f0' }}>
      <div style={{ display: 'flex', gap: '30px' }}>
        <div>
          ...
          <h2 style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#0f172a', fontWeight: '800' }}>{candidateNik}</h2>
        </div>
        <div>
          <p style={{ margin: 0, fontSize: '9px', color: '#64748b', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold' }}>Nama Peserta</p>
          <h2 style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#0f172a', fontWeight: '800' }}>{candidateName}</h2>
        </div>
      </div>
      <div style={{ textAlign: 'right' }}>
        ...
        <h3 style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#334155', fontWeight: '700' }}>{jobPosition}</h3>
      </div>
    </div>
  );
  ...
  // ================= CSS KHUSUS ANTI BLANK PAGE =================
  const a4PageStyle: React.CSSProperties = {
    width: '210mm',
    height: '296mm', // Diturunkan 1mm dari 297mm untuk safety margin
    padding: '8mm', // Padding dikurangi sedikit agar isi punya banyak ruang
    backgroundColor: '#fff',
    boxSizing: 'border-box',
    boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)',
    overflow: 'hidden', // INI KUNCI UTAMA: memotong tumpahan ukuran sekecil apapun
    display: 'flex',
  ...
  const innerBorderStyle: React.CSSProperties = {
    ...
    flex: 1, // Mengisi ruang yang tersisa persis, tidak lebih tidak kurang
    padding: '16px',
    boxSizing: 'border-box',
    display: 'flex',
    flexDirection: 'column',
    overflow: 'hidden' // Mengunci elemen di dalamnya
  };
  ...
  return (
    <div style={{ backgroundColor: '#e5e7eb', padding: '32px 0', display: 'flex', justifyContent: 'center', width: '100%', minHeight: '100vh', fontFamily: 'Arial, sans-serif' }}>
        ...
        {/* WADAH PDF */}
        {/* Kita buang gap: 32px agar pembuat PDF tidak menghitung gap antar halaman saat diprint */}
        <div id="pdf-content" style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={a4PageStyle}>
                <div style={innerBorderStyle}>
                    ...
                    <div style={{ display: 'flex', gap: '15px', marginBottom: '12px' }}>
                      <div style={{ flex: '1', backgroundColor: '#fff', padding: '10px', border: '1px solid #e2e8f0', borderTop: '4px solid #f59e0b', borderRadius: '4px' }}>
                        <h3 style={{ marginTop: 0, fontSize: '11px', color: '#b45309', borderBottom: '1px solid #e2e8f0', paddingBottom: '4px', marginBottom: '8px', fontWeight: 'bold' }}>Assesment - Kompetensi</h3>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fffbeb', padding: '8px', borderRadius: '4px' }}>
                          <div>
                            ...
                            <p style={{ fontSize: '9px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#92400e' }}>Human Resources</p>
                          </div>
                          <div style={{ fontSize: '18px', fontWeight: '900', color: '#b45309' }}>{competencyScore}%</div>
                        </div>
                      </div>

                      <div style={{ flex: '1', backgroundColor: '#fff', padding: '10px', border: '1px solid #e2e8f0', borderTop: '4px solid #06b6d4', borderRadius: '4px' }}>
                        <h3 style={{ marginTop: 0, fontSize: '11px', color: '#0e7490', borderBottom: '1px solid #e2e8f0', paddingBottom: '4px', marginBottom: '8px', fontWeight: 'bold' }}>Assesment - Value Behavior</h3>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#ecfeff', padding: '8px', borderRadius: '4px' }}>
                          <div>
                            ...
                            <p style={{ fontSize: '9px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#155e75' }}>Human Resources</p>
                          </div>
                          <div style={{ fontSize: '18px', fontWeight: '900', color: '#0e7490' }}>{behaviorScore}%</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#1e293b', padding: '12px', borderRadius: '4px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                      <div>
                        <p style={{ fontSize: '9px', color: '#94a3b8', margin: 0, fontWeight: 'bold', letterSpacing: '1px' }}>TOTAL SCORE</p>
                        <p style={{ fontSize: '24px', color: '#fff', fontWeight: '900', margin: '2px 0 0 0' }}>{totalScore.toFixed(2)}%</p>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <p style={{ fontSize: '9px', color: '#94a3b8', margin: 0, fontWeight: 'bold', letterSpacing: '1px' }}>FINAL REMARKS</p>
                        <div style={{ display: 'inline-block', backgroundColor: totalScore >= 70 ? '#10b981' : '#f59e0b', color: '#fff', padding: '4px 10px', borderRadius: '4px', fontWeight: 'bold', fontSize: '13px', margin: '4px 0' }}>
                          {finalStatus.remarks}
                        </div>
                        <p style={{ fontSize: '9px', color: '#cbd5e1', margin: 0 }}>Readyness: <strong style={{ color: '#fff' }}>{finalStatus.readyness}</strong></p>
                      </div>
                    </div>

                    {/* TABEL MATRIKS KEPUTUSAN */}
                    <h3 style={{ fontSize: '11px', color: '#1e3a8a', fontWeight: 'bold', marginBottom: '4px' }}>Matriks Rekomendasi Kelulusan</h3>
            ...
            {/* ========================================================= */}
            {/* FORCE PAGE BREAK YANG DIRAPIKAN */}
            {/* ========================================================= */}
            <div className="html2pdf__page-break" style={{ pageBreakBefore: 'always', margin: 0, padding: 0, height: 0, border: 'none' }}></div>
            ...
            <div style={a4PageStyle}>
                <div style={innerBorderStyle}>
                  ...
                  <div style={{ display: 'flex', gap: '15px', marginBottom: '12px' }}>
                    <div style={{ flex: '1', backgroundColor: '#fff', padding: '10px', border: '1px solid #e2e8f0', borderTop: '4px solid #3b82f6', borderRadius: '4px' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '6px' }}>
                        <div style={{ backgroundColor: '#f8fafc', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          ...
                          <p style={{ fontSize: '13px', fontWeight: '900', margin: '2px 0 0 0', color: '#1e40af' }}>{cfit?.iq || '-'}</p>
                        </div>
                        <div style={{ backgroundColor: '#f8fafc', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          <p style={{ fontSize: '8px', color: '#64748b', margin: 0, textTransform: 'uppercase', fontWeight: 'bold' }}>Klasifikasi</p>
                          <p style={{ fontSize: '9px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#0f172a' }}>{cfit?.classification || '-'}</p>
                        </div>
                        <div style={{ backgroundColor: '#f8fafc', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          <p style={{ fontSize: '8px', color: '#64748b', margin: 0, textTransform: 'uppercase', fontWeight: 'bold' }}>Jwb Benar</p>
                          <p style={{ fontSize: '13px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#0f172a' }}>{cfit?.raw_score ?? '-'}</p>
                        </div>
                      </div>
                    </div>

                    <div style={{ flex: '1', backgroundColor: '#fff', padding: '10px', border: '1px solid #e2e8f0', borderTop: '4px solid #10b981', borderRadius: '4px' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '6px' }}>
                        <div style={{ backgroundColor: '#fcf8ea', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          ...
                          <p style={{ fontSize: '13px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#78350f' }}>{kraepelin?.kecepatan || kraepelin?.panker || '-'}</p>
                        </div>
                        <div style={{ backgroundColor: '#f0fdf4', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          ...
                          <p style={{ fontSize: '13px', fontWeight: 'bold', margin: '2px 0 0 0', color: '#14532d' }}>{kraepelin?.ketelitian || kraepelin?.janker || '-'}</p>
                        </div>
                        <div style={{ backgroundColor: '#fef2f2', padding: '6px', borderRadius: '4px', textAlign: 'center' }}>
                          ...
                          <p style={{ fontSize: '13px', fontWeight: '900', margin: '2px 0 0 0', color: '#b91c1c' }}>{totalErrors}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ backgroundColor: '#fff', padding: '12px', border: '1px solid #e2e8f0', borderTop: '4px solid #8b5cf6', borderRadius: '4px', flex: 1 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', columnGap: '20px', rowGap: '5px' }}>
